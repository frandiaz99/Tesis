...
PARAMETER(PAPI_VERSION=117637120)
INTEGER PAPI_VER_CURRENT  
PARAMETER(PAPI_VER_CURRENT=117637120)
...
INTEGER PAPI_HP_OPS       
PARAMETER(PAPI_HP_OPS=-2147483540)
INTEGER PAPI_HW_INT       
...
INTEGER PAPI_VEC_HP       
PARAMETER(PAPI_VEC_HP=-2147483539)
